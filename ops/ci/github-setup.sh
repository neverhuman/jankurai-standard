...
git -C "$source_root/core" checkout --detach 4cec8abdde44565abd25cd1f6f2a6694f7e16270
[[ "$(git -C "$source_root/core" rev-parse HEAD)" == 4cec8abdde44565abd25cd1f6f2a6694f7e16270 ]]
