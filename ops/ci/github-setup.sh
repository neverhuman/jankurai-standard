...
git -C "$source_root/core" checkout --detach 821868875fe81c0f78eab8de8c43c70654933b6c
[[ "$(git -C "$source_root/core" rev-parse HEAD)" == 821868875fe81c0f78eab8de8c43c70654933b6c ]]
