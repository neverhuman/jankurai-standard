...
git -C "$source_root/core" checkout --detach bb4002632c7190eb27ff589a39132195f5f96f23
[[ "$(git -C "$source_root/core" rev-parse HEAD)" == bb4002632c7190eb27ff589a39132195f5f96f23 ]]
